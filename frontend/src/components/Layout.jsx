...
const navItems = [
  ...
  { path: "/qibla", label: "القبلة" },
  { path: "/tasbih", label: "التسبيح" },
  { path: "/investment", label: "الاستثمار" },
  { path: "/net-salary", label: "الراتب الصافي" },
  { path: "/qr", label: "QR" },
  { path: "/password", label: "كلمات المرور" },
  { path: "/text-tools", label: "النصوص" },
  { path: "/bill-split", label: "قسمة الفاتورة" },
  { path: "/pomodoro", label: "بومودورو" },
  { path: "/countdown", label: "عدّاد تنازلي" },
  { path: "/gpa", label: "GPA" },
  { path: "/colors", label: "الألوان" },
  { path: "/planet-age", label: "عمرك بالكواكب" },
  { path: "/social", label: "روابط سوشيال" },
  { path: "/lottery", label: "قرعة" },
  { path: "/calories", label: "السعرات" },
  { path: "/ramadan", label: "رمضان" },
  { path: "/pregnancy", label: "الحمل" },
  { path: "/body-comp", label: "اللياقة" },
  { path: "/sleep", label: "النوم" },
  { path: "/wedding", label: "الزواج" },
  { path: "/budget", label: "الميزانية" },
  { path: "/electricity", label: "الكهرباء" },
  { path: "/retirement", label: "التقاعد" },
  { path: "/uni-score", label: "الجامعة" },
  { path: "/final-grade", label: "الدرجة النهائية" },
  { path: "/json", label: "JSON" },
  { path: "/base64", label: "Base64" },
  { path: "/timestamp", label: "Timestamp" },
  { path: "/number-bases", label: "أنظمة العد" },
  { path: "/color-conv", label: "محول الألوان" },
  { path: "/world-clock", label: "ساعة عالمية" },
  { path: "/stopwatch", label: "ساعة إيقاف" },
  { path: "/hashtags", label: "هاشتاقات" },
  { path: "/lorem", label: "Lorem" },
  { path: "/wheel", label: "دولاب الحظ" },
        ...
        <div className="mt-10 pt-6 border-t border-primary-foreground/20 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-primary-foreground/70">
          ...
          <div className="text-center sm:text-left">
            ...
            <a
              ...
              data-testid="credit-mowayqi-email"
